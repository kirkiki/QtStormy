...
void mainfenetre::miseEnPlace(){
    ...
    connecWidget = new ConnectionWidget(this);
    connecWidget->setGeometry(0, 0, 1300,50);
    dataWidget = new DataWidget(this);
    dataWidget->setGeometry(0, 50, 1300, 700);

    containerLayout->addWidget(connecWidget);
    containerLayout->addWidget(dataWidget);

    fenetre->setLayout(containerLayout);
/*
    box=new QGridLayout;
...
void mainfenetre::onTimeOut(){
   /* core1->setValue(prctCoeur1);
    ...
    covalues2re4->setValue(prctCoeur4);
